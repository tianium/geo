...
Punycode编码遵循RFC 3492标准，当DNS系统兼容时，浏览器自动将Punycode转译为用户可读的网址，日常编解码可使用在线转换工具，如 [Punycoder](https://punycoder.com/)，输入“😊.com”就会生成“xn--o28h.com”，同时也可进行反解。注册域名时，需要我们在注册商的网站上填写这个以“xn--”开头的转化后的域名，注册好以后就可在浏览器地址栏直接使用emoji地址访问了。
